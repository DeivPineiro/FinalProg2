...
$instrumentos = $miObjGtr->cargar_catalogo();
...
<div class="container bg-white my-5 rounded shadow">
    <h1 class="h2 text-center p-4 text-secondary">Catalogo completo</h1>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <a href="index.php?sec=instrumento&id=<?= $guitarra->getId() ?>" class="btn btn-warning w-20 d-grid gap-2 col-6 mx-auto min-width ">Ver mas...</a>
                        </div>
